...
export default function HotelDetailContent({
  ...
  return (
    <>
      ...
      <div
        className={`mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-8 md:px-10 lg:gap-16 lg:py-16 ${
          sidebar ? 'lg:grid-cols-[1fr_380px]' : ''
        }`}
      >
        <div className="min-w-0">
          {showOverviewSection && (
            <section aria-labelledby="overview-title" className="mb-8 lg:mb-14">
              <SectionTitle
                id="overview-title"
          ...
          {rooms.length > 0 && (
            <section aria-labelledby="rooms-title" className="mb-8 lg:mb-14">
              <SectionTitle
                id="rooms-title"
          ...
          {features.length > 0 && (
            <section aria-labelledby="amenities-title" className="mb-8 lg:mb-14">
              <SectionTitle
                id="amenities-title"
          ...
          {showLocationSection && (
            <section aria-labelledby="location-title" className="mb-8 lg:mb-14">
              <SectionTitle
                id="location-title"
          ...
          <section aria-labelledby="reviews-title" className="mb-8 lg:mb-14">
            <SectionTitle
              id="reviews-title"
          ...
          {faqs.length > 0 && (
            <section aria-labelledby="faq-title" className="mb-8 lg:mb-14">
              <SectionTitle
                id="faq-title"
