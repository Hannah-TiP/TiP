...
ARG NEXT_PUBLIC_ENABLE_PREVIEW_MODE
ARG NEXT_PUBLIC_FLYWIRE_SCRIPT_URL
ARG NEXT_PUBLIC_FLYWIRE_ENV
...
ENV NEXT_PUBLIC_ENABLE_PREVIEW_MODE=$NEXT_PUBLIC_ENABLE_PREVIEW_MODE
ENV NEXT_PUBLIC_FLYWIRE_SCRIPT_URL=$NEXT_PUBLIC_FLYWIRE_SCRIPT_URL
ENV NEXT_PUBLIC_FLYWIRE_ENV=$NEXT_PUBLIC_FLYWIRE_ENV
